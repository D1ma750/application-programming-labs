...
from work_with_image import create_hist_of_channels, show_histogram, changing_image_size, show_image
...
def main():
    ...
    try:
        ...
        print(image.shape)
        blue, green, red = create_hist_of_channels(image)
        show_histogram(blue, green, red)
